...
public class Prizonier2 extends Character
{
    ...
    public Prizonier2(RefLinks refLink, float x, float y, boolean orientation)
    {
        super(refLink, x, y, Character.DEFAULT_SIZE);

        if(orientation)
        {
            skin = Assets.prizonier2_r;
        }
        else
        {
            skin = Assets.prizonier2_l;
        }
